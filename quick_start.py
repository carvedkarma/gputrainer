    ...
    base = [
        {"name": "baseline", "overrides": {}},
        {
            ...
            "overrides": {
                ...
                "nonconformity_target_reject_rate": 0.60,
                "counterfactual_target_reject_rate": 0.68,
                "counterfactual_reject_tolerance": 0.08,
                "calibration_target_abs_error": 0.12,
                "calibration_target_brier": 0.18,
                "calibration_conf_scale": 0.070,
                "calibration_edge_scale": 0.012,
                "calibration_uncertainty_scale": 0.70,
                "calibration_max_conf_adjust": 0.16,
                "calibration_max_edge_adjust": 0.025,
                "calibration_participation_min_scale": 0.12,
            },
        },
        {
    ...
    ultra = [
        {
            ...
            "overrides": {
                ...
                "precision_selective_base_quantile": 0.80,
                "precision_selective_max_quantile": 0.96,
                "precision_selective_target_win_rate": 0.58,
                "precision_selective_adapt_gain": 0.60,
                "min_confidence": 0.58,
                "min_edge_threshold": 0.020,
                "min_expected_r": 0.008,
                "max_trades_per_day": 14,
                "side_rebalance_short_target": 0.36,
                "min_size_mult": 10.0,
                "max_size_mult": 200.0,
                "conviction_max_size_mult": 200.0,
                "max_leverage": 200.0,
        ...
        },
        {
            ...
            "overrides": {
                ...
                "precision_selective_target_win_rate": 0.57,
                "precision_selective_adapt_gain": 0.52,
                "min_confidence": 0.57,
                "min_edge_threshold": 0.019,
...
Examples:
  ...
  python quick_start.py --url URL --live --dry-run --dry-run-candles 200
    ...
    parser.add_argument("--mythos-min-leverage", type=float, default=0.5,
                        help="MYTHOS minimum leverage multiplier / size floor (default: 0.5)")
    ...
    if not args.predict_only:
        ...
        if args.train_mythos:
            ...
            mythos_cfg = MythosConfig(
                ...
                min_size_mult=args.mythos_min_leverage,
                max_size_mult=args.mythos_max_leverage,
